...
//Made by Abd Almonem Doolaanea maker4ir@gmail.com
//This code is added with RTC to the cold water bath + thermistor + DS18B20 + SD card + Google sheet + OLED
...
U8G2_SSD1306_128X64_NONAME_F_SW_I2C u8g2(U8G2_R0, /* clock=*/ 14, /* data=*/ 27, /* reset=*/ U8X8_PIN_NONE);   // All Boards without Reset of the Display
//////////////////
...
appendFile(SD, "/TempLog.txt", "Date, Time(Actual), Time(Duration),Temp C Thermistor,Temp C DS18B20");
...
//SD
Temp_data = String(year) + "/" + String(month) + "/" + String(day) + "," + String(hour) + "." + String(minute) + "." + String(sec) + "," + String(millis()) + "," + String(temp) + "," + String(tempC) + "\n";
