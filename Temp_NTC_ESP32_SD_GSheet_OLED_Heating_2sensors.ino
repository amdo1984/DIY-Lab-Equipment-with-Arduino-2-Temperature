////CONTROLLING T WITH HEATING PAD ADVANCED 2 T SENSORS/////////////
//Use ESP32
...
//relay
// pinMode(relay_pin, OUTPUT); //uncomment this if using relay
// digitalWrite(relay_pin, LOW);//uncomment this if using relay
...
//fast heating for far temperature value
heating_power = 64 ;

if (temp < (target_temp - 15))
{
  heating_power = 200 ;
}

//ON OFF the heating
if (tempC > target_temp || temp > (target_temp + temp_var))
  {
  ...
  {
    ledcWrite(ledChannel, heating_power) ;
  }
