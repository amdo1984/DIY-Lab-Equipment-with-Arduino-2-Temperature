...
//SD
  ...
  //Adding title line in the file every time ESP32 starts
...
appendFile(SD, "/TempLog.txt", Temp_data.c_str()); //adding .c_str is very important to write the string variable, not needed if we write text (string) directly.
}