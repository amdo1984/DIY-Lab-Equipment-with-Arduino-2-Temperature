////CONTROLLING T WITH HEATING ELEMENT/////////////
//Use ESP32
...
//heating control, using this code can work with full heat or PWM heating using MOSFET. Using relay is even simpler using digitalWrite function.
if (tempC > 40)
  {
